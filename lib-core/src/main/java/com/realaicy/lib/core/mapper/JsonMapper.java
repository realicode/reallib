...
public final class JsonMapper {
     ...
     */
    public JavaType contructCollectionType(final Class<? extends Collection> collectionClass,
     ...
     * @return the java type
     */
    public JavaType contructMapType(final Class<? extends Map> mapClass, final Class<?> keyClass,
