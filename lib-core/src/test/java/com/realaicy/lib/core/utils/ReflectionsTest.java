package com.realaicy.lib.core.utils;
...
public class ReflectionsTest {
    ...
    public void invokeMethod() {
        ...
        assertThat(
                Reflections
                        .invokeMethod(bean, "privateMethod", new Class[]{String.class}, new Object[]{"realaicy"}))
                .isEqualTo("hello realaicy");

        // 仅匹配函数名
        assertThat(Reflections.invokeMethodByName(bean, "privateMethod", new Object[]{"realaicy"})).isEqualTo(
                "hello realaicy");

        // 函数名错
        try {
            Reflections.invokeMethod(bean, "notExistMethod", new Class[]{String.class}, new Object[]{"realaicy"});
            failBecauseExceptionWasNotThrown(IllegalArgumentException.class);
        } catch (IllegalArgumentException ignored) {
    ...
    public void getUserClass() {
        TestBean bean = new TestBean();
        assertThat(Reflections.getUserClass(bean)).isEqualTo(TestBean.class);
    }
